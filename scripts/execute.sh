...
cd $halo_dir1
halo_name1=`ls *$zzzz*$catalogue_number*_halos`
halo_name2=`ls *$zzzz*$catalogue_number*_halos`
echo $halo_name1

cd $halo_dir1
profile_name1=`ls *$zzzz*$catalogue_number*_profiles`
profile_name2=`ls *$zzzz*$catalogue_number*_profiles`
echo $halo_name1
